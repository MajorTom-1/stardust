...
-- 2)	Наполнить таблицу employee 70 строками (на сайте взять имена: https://randomus.ru/name?type=101&sex=10&count=70 а в excel можно формулой прогнать ="('"&B3:B3&"')," )
...
role_id int not null references roles_3 (id)
)
